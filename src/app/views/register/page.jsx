                ...
                <form className="space-y-4" onSubmit={handleRegister}>
                    <div>
                        ...
                        <input
                            ...
                            className="mt-1 w-full text-black border border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-200 placeholder:text-gray-300"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Email"
                            className="mt-1 w-full border text-black border-gray-300 rounded-md p-2 focus:ring focus:ring-blue-200 placeholder:text-gray-300"
                        />
                    </div>
